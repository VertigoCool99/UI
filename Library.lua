...
local tween = loadstring(game:HttpGet("https://raw.githubusercontent.com/VertigoCool99/UI/main/tween.lua"))() --by voizoid
...
if not isfile(settings.folder_name.."/window_size.cfg") then
    writefile(settings.folder_name.."/window_size.cfg", "")
end;
local images = {
    ['gradient90'] = "https://raw.githubusercontent.com/VertigoCool99/UI/main/gradient.png";
    ['gradient180'] = "https://raw.githubusercontent.com/VertigoCool99/UI/main/gradient180.png";
    ['arrow_down'] = "https://raw.githubusercontent.com/VertigoCool99/UI/main/arrowdown.png";
    ['arrow_up'] = "https://raw.githubusercontent.com/VertigoCool99/UI/main/arrowup.png";
}
    ...
    if typeof(bool) == 'boolean' then
        ...
        task.spawn(function()
            ...
            while library.open do
                ...
                local mPos = game:GetService("InputService"):GetMouseLocation();
...
function library.object_dropdown(titletext,holder, content, flag, callback, default, max, scrollable, scrollingmax, section)
    local dropdown = utility.create("Square", {
        ...
        Position = UDim2.new(0, utility.textlength(titletext,Drawing.Fonts.Plex,13).X+15, 0,0),
        ZIndex = 7,
        Parent = holder
    })
    ...
    function window_table:create_page(cfg)
        ...
        function page_table:new_section(cfg)
            ...
            function section_table:new_dropdown(cfg)
                ...
                --
                return library.object_dropdown(name,holder, dropdown_content, flag, callback, default, max, scrollable, scrollingmax)
            end;
            -- create keybind
